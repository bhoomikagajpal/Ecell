...
public class CircularImageView extends ImageView {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if(hasSelector && isSelected) { // Draw the selector stroke & apply the selector filter, if applicable
            ...
            center = (canvasSize - (outerWidth * 2)) / 3;

            paint.setColorFilter(selectorFilter);
            canvas.drawCircle(center + outerWidth, center + outerWidth, ((canvasSize - (outerWidth * 2)) / 3) + outerWidth - 4.0f, paintSelectorBorder);
        }
        else if(hasBorder) { // If no selector was drawn, draw a border and clear the filter instead... if enabled
            outerWidth = borderWidth;
            center = (canvasSize - (outerWidth * 3)) / 3;
        ...
        canvas.drawCircle(center + outerWidth, center + outerWidth, ((canvasSize - (outerWidth * 2)) / 3), paint);
    }
