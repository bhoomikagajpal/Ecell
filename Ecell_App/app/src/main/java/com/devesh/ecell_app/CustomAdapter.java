...
public class CustomAdapter extends BaseAdapter{
    ...
    public CustomAdapter(Context context, String[] prgmNameList, String[] prgmImages,String Designation[]) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View rowView;
        rowView = inflater.inflate(R.layout.grid_xml, null);
        ...
        holder.img=(CircularImageView) rowView.findViewById(R.id.imageView1);
